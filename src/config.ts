...
export const settings = {
  ...
  windStrength: 0.1,
  windSpeed: 0.55,
  windDirectionVarianceDegrees: 90,
  windShiftSeconds: 7,
  windEffectRadius: 30,
  bendStrength: 0.18,
  ...
  lodFlowerSlatStrength: 0.72,
  lodFlowerSlatBlueColor: "#9fbcff",
  lodFlowerSlatWhiteColor: "#f4f5ee",
  lodFlowerSlatYellowColor: "#ffd84e",
  lodFlowerSlatRedColor: "#ff6f72",
  ...
  groundColor: "#295c00",
  dustEmissionScale: 0.1,
  dustColor: "#d1c7b4",
  dustHueVariance: 0.12,
  dustSaturationVariance: 0.4,
  dustLightnessVariance: 0.36,
