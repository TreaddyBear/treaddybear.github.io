...
| `src/assets/wall-bump-soft.mp3`     | Derived placeholder        | Copied from `src/assets/wall-bump.mp3`                                                                                                                           | CC0 (both) | Duplicate for severity tuning        | No                   | Soft fence bump tier; replace/tune later.                              |
| `src/assets/wall-bump-medium.mp3`   | Derived placeholder        | Copied from `src/assets/wall-bump.mp3`                                                                                                                           | CC0 (both) | Duplicate for severity tuning        | No                   | Medium fence bump tier; replace/tune later.                            |
| `src/assets/wall-bump-hard.mp3`     | Derived placeholder        | Copied from `src/assets/wall-bump.mp3`                                                                                                                           | CC0 (both) | Duplicate for severity tuning        | No                   | Hard fence crash tier; replace/tune later.                             |
